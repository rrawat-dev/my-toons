...
function getCharacters() {
  ...
  var gender = (params.gender || []).map(function (gender) {
    return "gender=".concat(species);
  }).join('&');
  var page = "page=".concat(params.page || 1);
  var name = "name=".concat(params.searchText || '');
  return _http__WEBPACK_IMPORTED_MODULE_0__["default"].get("https://rickandmortyapi.com/api/character/?".concat(species, "&").concat(gender, "&").concat(page, "&").concat(name));
  /*
...
//# sourceMappingURL=index.js.cfe3d6e09e1fcc84bb6b.hot-update.js.map